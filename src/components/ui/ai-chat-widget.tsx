...
export function AIChatWidget() {
  ...
  // Try LLM API first, fall back to local intent matching
  const findResponse = async (query: string): Promise<string> => {
    ...
    // Fallback: local intent-based matching
  ...
  const handleSend = (text?: string) => {
    ...
    findResponse(query).then((response) => {
